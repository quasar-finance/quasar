...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          message.poolSpotPriceList.push(
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (
      object.poolPositionList !== undefined &&
    ...
    if (
      object.poolSpotPriceList !== undefined &&
  ...
  toJSON(message: GenesisState): unknown {
    ...
    if (message.poolPositionList) {
      obj.poolPositionList = message.poolPositionList.map((e) =>
    ...
    if (message.poolSpotPriceList) {
      obj.poolSpotPriceList = message.poolSpotPriceList.map((e) =>
    ...
    if (message.poolInfoList) {
      obj.poolInfoList = message.poolInfoList.map((e) =>
