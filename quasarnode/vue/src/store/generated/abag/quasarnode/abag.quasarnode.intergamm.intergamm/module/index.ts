...
const types = [
  ...
  ["/abag.quasarnode.intergamm.intergamm.MsgRegisterAccount", MsgRegisterAccount],
...
const txClient = async (wallet: OfflineSigner, { addr: addr }: TxClientOptions = { addr: "http://localhost:26657" }) => {
  ...
  return {
    ...
    msgRegisterAccount: (data: MsgRegisterAccount): EncodeObject => ({ typeUrl: "/abag.quasarnode.intergamm.intergamm.MsgRegisterAccount", value: MsgRegisterAccount.fromPartial( data ) }),
