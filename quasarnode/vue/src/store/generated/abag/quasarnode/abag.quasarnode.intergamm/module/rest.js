...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryInterchainAccountFromAddress = (query, params = {}) => this.request({
            path: `/abag/quasarnode/intergamm/interchain_account_from_address`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
        ...
        this.queryParams = (params = {}) => this.request({
            path: `/abag/quasarnode/intergamm/params`,
            method: "GET",
            format: "json",
            ...params,
        });
