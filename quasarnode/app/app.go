...
func New(
	...
	*/
	...
	intergammIBCModule := intergamm.NewIBCModule(app.IntergammKeeper)
	...
	// TODO: Add all other modules with the required orders
	app.mm.SetOrderBeginBlockers(
		upgradetypes.ModuleName, authtypes.ModuleName, capabilitytypes.ModuleName, evidencetypes.ModuleName, minttypes.ModuleName, distrtypes.ModuleName, slashingtypes.ModuleName,
		banktypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName, crisistypes.ModuleName, genutiltypes.ModuleName, feegrant.ModuleName, ibctransfertypes.ModuleName,
		paramstypes.ModuleName, "ibc", vestingtypes.ModuleName, qbankmoduletypes.ModuleName, osmolpvmoduletypes.ModuleName, qoraclemoduletypes.ModuleName, icatypes.ModuleName, intergammmoduletypes.ModuleName,
	)
	...
	app.mm.SetOrderEndBlockers(upgradetypes.ModuleName, capabilitytypes.ModuleName, minttypes.ModuleName, distrtypes.ModuleName, slashingtypes.ModuleName,
		...
		paramstypes.ModuleName, vestingtypes.ModuleName, ibctransfertypes.ModuleName, qbankmoduletypes.ModuleName,
