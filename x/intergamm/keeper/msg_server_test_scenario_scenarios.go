...
func createPool(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcCreatePool(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func joinSwapExternAmountIn(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcJoinSwapExternAmountIn(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func exitSwapExternAmountOut(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcExitSwapExternAmountOut(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func joinSwapShareAmountOut(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcJoinSwapShareAmountOut(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func exitSwapShareAmountIn(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcExitSwapShareAmountIn(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func lockTokens(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcLockTokens(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func beginUnlocking(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	_,_, err := k.TransmitIbcBeginUnlocking(
		ctx,
		owner,
		connectionId,
		timestamp,
...
func icaTransferIbcTokens(t *testing.T, ctx sdk.Context, k *Keeper) {
	...
	seq, _, err := k.TransmitICATransfer(
		ctx,
		owner,
