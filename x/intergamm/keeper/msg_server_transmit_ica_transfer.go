...
func (ms msgServer) TransmitICATransfer(goCtx context.Context, msg *types.MsgTransmitICATransfer) (*types.MsgTransmitICATransferResponse, error) {
	...
	seq, err := ms.k.TransmitICATransferGeneral(ctx, msg.IcaOwnerAddress, msg.IcaZoneId, msgTransmitTimeoutTimestamp, msg.Coin, msg.ToAddress, icaTransferTimeoutHeight, icaTransferTimeoutTimestamp)
	if err != nil {
		return nil, err
	}

	return &types.MsgTransmitICATransferResponse{Seq: seq}, nil
}
