...
var (
	...
	_ gammtypes.CreatePoolMsg = &MsgCreateBalancerPool{}
)
...
func (msg MsgCreateBalancerPool) Route() string { return gammtypes.RouterKey }
...
func (msg MsgCreateBalancerPool) ValidateBasic() error {
	...
	if err = gammtypes.ValidateFutureGovernor(msg.FuturePoolGovernor); err != nil {
		return err
	}
...
func (msg MsgCreateBalancerPool) CreatePool(ctx sdk.Context, poolID uint64) (gammtypes.PoolI, error) {
