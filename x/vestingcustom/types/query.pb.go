...
// source: vestingcustom/query.proto
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "quasarlabs.quasarnode.vestingcustom.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "quasarlabs.quasarnode.vestingcustom.QueryParamsResponse")
}

func init() { proto.RegisterFile("vestingcustom/query.proto", fileDescriptor_2abc236b445aadb5) }
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/quasarlabs.quasarnode.vestingcustom.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/quasarlabs.quasarnode.vestingcustom.Query/Params",
	}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "quasarlabs.quasarnode.vestingcustom.Query",
	...
	Metadata: "vestingcustom/query.proto",
}
