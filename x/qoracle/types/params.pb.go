...
type BandchainParams struct {
	...
	CoinRatesScriptParams OracleScriptParams `protobuf:"bytes,2,opt,name=coin_rates_script_params,json=coinRatesScriptParams,proto3" json:"coin_rates_script_params" yaml:"coin_rates_script_params"`
}
...
func (m *BandchainParams) GetCoinRatesScriptParams() OracleScriptParams {
	if m != nil {
		return m.CoinRatesScriptParams
	}
...
type OracleScriptParams struct {
	...
	AskCount        uint64                                   `protobuf:"varint,3,opt,name=ask_count,json=askCount,proto3" json:"ask_count,omitempty" yaml:"ask_count"`
	MinCount        uint64                                   `protobuf:"varint,4,opt,name=min_count,json=minCount,proto3" json:"min_count,omitempty" yaml:"min_count"`
	FeeLimit        github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,5,rep,name=fee_limit,json=feeLimit,proto3,castrepeated=github.com/cosmos/cosmos-sdk/types.Coins" json:"fee_limit"`
	PrepareGas      uint64                                   `protobuf:"varint,6,opt,name=prepare_gas,json=prepareGas,proto3" json:"prepare_gas,omitempty" yaml:"prepare_gas"`
	ExecuteGas      uint64                                   `protobuf:"varint,7,opt,name=execute_gas,json=executeGas,proto3" json:"execute_gas,omitempty" yaml:"execute_gas"`
}
...
func (m *OracleScriptParams) GetEpochIdentifier() string {
	if m != nil {
...
var fileDescriptor_95f4338228c132f2 = []byte{
	...
	,
}
...
func (m *BandchainParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.CoinRatesScriptParams.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *BandchainParams) Size() (n int) {
	...
	l = m.CoinRatesScriptParams.Size()
	n += 1 + l + sovParams(uint64(l))
	return n
}
...
func (m *BandchainParams) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CoinRatesScriptParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CoinRatesScriptParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
