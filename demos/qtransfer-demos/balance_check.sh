...
echo "user address - $(quasard keys show alice -a --keyring-backend test --home ~/.quasarnode)"
quasard q bank balances quasar1sqlsc5024sszglyh7pswk5hfpc5xtl77gqjwec --node tcp://localhost:26659 -o json
