...
SIGNER1_ADDRESS=$(quasard keys show signer1 -a --keyring-backend test)
SIGNER2_ADDRESS=$(quasard keys show signer2 -a --keyring-backend test)
SIGNER3_ADDRESS=$(quasard keys show signer3 -a --keyring-backend test)
...
quasard tx sign tx.json --from signer1 --multisig $MULTISIG_ADDRESS --chain-id $CHAIN_ID --keyring-backend test --output-document tx_signed1.json
quasard tx sign tx.json --from signer2 --multisig $MULTISIG_ADDRESS --chain-id $CHAIN_ID --keyring-backend test --output-document tx_signed2.json
quasard tx sign tx.json --from signer3 --multisig $MULTISIG_ADDRESS --chain-id $CHAIN_ID --keyring-backend test --output-document tx_signed3.json
