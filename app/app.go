...
func New(
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), authtypes.ProtoBaseAccount, maccPerms, "quasar", // TODO: Make a const for this
	)
	...
	intergammIBCModule := intergammmodule.NewIBCModule(app.IntergammKeeper)

	icaControllerIBCModule := icacontroller.NewIBCMiddleware(intergammIBCModule, app.ICAControllerKeeper)
