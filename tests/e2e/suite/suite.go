...
import (
	...
	ibctenderminttypes "github.com/cosmos/ibc-go/v4/modules/light-clients/07-tendermint/types"
...
// GetConnectionsByPath returns all the available ibc connections between chain1 and chain2.
...
func unmarshalTxResult(bz []byte, ptr proto.Message) error {
	...
	default:
		return errors.Errorf("invalid sdk.TxMsgData len(msgData.Data) = %v, len(msgData.MsgResponses) = %v", len(msgData.Data))
	}
	return err
}
