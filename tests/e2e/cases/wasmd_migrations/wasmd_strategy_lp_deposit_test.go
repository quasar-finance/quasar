...
const (
	...
	oldLpStrategyContractPath            = "./resources/contract_binaries/old_lp_strategy-aarch64.wasm"
	oldBasicVaultContractPath            = "./resources/contract_binaries/old_lp_strategy-aarch64.wasm"
