...
func ConvertBech32Cmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Short: "Convert any bech32 string to the quasar prefix",
		Long: `Convert any bech32 string to the quasar prefix
Especially useful for converting cosmos addresses to quasar addresses

Example:
	quasard bech32-convert cosmos1ey69r37gfxvxg62sh4r0ktpuc46pzjrmz29g45
	`,
	...
	cmd.Flags().StringP(flagBech32Prefix, "p", "quasar", "Bech32 Prefix to encode to")
