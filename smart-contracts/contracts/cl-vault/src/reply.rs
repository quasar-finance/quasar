...
use crate::{
    ...
    vault::{
        ...
        range::{handle_withdraw_position_reply, handle_initial_create_position_reply, handle_iteration_create_position_reply, handle_fungify_charged_positions_response, handle_swap_reply},
...
pub fn handle_reply(deps: DepsMut, env: Env, msg: Reply) -> Result<Response, ContractError> {
    match msg.id.into() {
        ...
        Replies::RangeIterationCreatePosition => handle_iteration_create_position_reply(deps, env, msg.result),
