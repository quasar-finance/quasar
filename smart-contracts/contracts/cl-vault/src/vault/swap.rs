...
use cosmwasm_std::{
    to_json_binary, Addr, Coin, CosmosMsg, DepsMut, Env, Fraction, MessageInfo, Response, Uint128,
    WasmMsg,
};
use cw_dex_router::{
    msg::{
...
// fn find_optimal_swap_operation_route(
//     querier: QuerierWrapper,
//     dex_router_addr: &Addr,
//     current_swap_route: &Option<SwapOperationsListUnchecked>, // TODO: Rename to recommended_swap_route
//     token_in_denom: &String,
//     token_in_amount: Uint128,
//     token_out_denom: &String,
//     force_swap_route: bool, // this true wants Some(current_swap_route)
// ) -> Result<CosmosMsg, ContractError> {
//     let offer_asset = AssetInfo::Native(token_in_denom.to_string());
//     let ask_asset = AssetInfo::Native(token_out_denom.to_string());

//     // recommended out it computed based on the simulation of the swap operations we perform against the cw-dex-router
//     // using the recommended_swap_route
...
//     // best_path is retrieven by the iteration on the cw-dex-router using all the paths available on its state
//     // and picking up the one with higher token_out_amount
...
//     let token_out_min_amount = todo!();

//     // TODO: If we reach that point with a 0 token_out_min_amount
//     // which is lower than allowed by config.max_slippage throw an Error()
