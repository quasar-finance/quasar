...
mod tests {
    ...
    // TODO: This has been reverted to the current main version, this should now take in account that amoun_of_users has been removed and this is just a single operation, not paginated anymore.
    // This is way simpler now, we just claim, subtract protorev and send them to treasury. All the rest is vault's fund and it will be left idle in the balance pending to be autocompounded.
    ...
    fn test_rewards_single_distribute_claim() {
        ...
        let tokens_out_spread_rewards_u128: u128 =
            get_amount_from_denom(&tokens_out_spread_rewards[0].value);
    ...
    fn test_rewards_single_distribute_claim_cycles() {
        ...
        for _ in 0..DISTRIBUTION_CYCLES {
            ...
            // TODO: This is autocompounded now
            // Distribute one more time to finish, even if we extra deposited with one more user we expect the distribution to finish
            // let result = wasm
            //     .execute(
            //         contract_address.as_str(),
    ...
    fn test_rewards_single_distribute_claim_no_rewards_works() {
        ...
        // TODO: This is autocompounded now, not paginated
    ...
    fn test_rewards_single_distribute_claim_deposit_between() {
        ...
        let expected_rewards_per_user_double = expected_rewards_per_user * 2;
