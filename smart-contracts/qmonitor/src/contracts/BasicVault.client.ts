...
export interface BasicVaultReadOnlyInterface {
  ...
  additionalTokenInfo: () => Promise<VaultTokenInfoResponse>
  allowance: ({
    owner,
    spender,
  }: {
...
export class BasicVaultQueryClient implements BasicVaultReadOnlyInterface {
  ...
  getCap = async (): Promise<GetCapResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
      get_cap: {},
    })
  }
  ...
  additionalTokenInfo = async (): Promise<VaultTokenInfoResponse> => {
    return this.client.queryContractSmart(this.contractAddress, {
