...
//! Generated file from `v1beta1/test.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_0;

// @@protoc_insertion_point(message:Fruit)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct Fruit {
    // message fields
    // @@protoc_insertion_point(field:Fruit.name)
    pub name: ::std::option::Option<::std::string::String>,
    // @@protoc_insertion_point(field:Fruit.weight)
    pub weight: ::std::option::Option<f32>,
    // special fields
    // @@protoc_insertion_point(special_field:Fruit.special_fields)
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    (\tR\x04name\x12\x16\n\x06weight\x18\x02\x20\x01(\x02R\x06weight\
";
